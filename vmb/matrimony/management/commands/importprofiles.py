...
def get_marital_status(a):
    if "Never Married" in a: mar_sts = "UMR"
    else: mar_sts = a[0:3].upper()
    return mar_sts
...
def get_spiritual_status(a):
    if "First Initiated" in a: s_status= "D1"
    elif "Second Initiated" in a: s_status= "D2"    
    else: s_status=a[0].upper() 
    return s_status
