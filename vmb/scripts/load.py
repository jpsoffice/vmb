...
from matrimony.models import MatrimonyProfile, Guru, Country, Nationality, Language, Degree, 
Occupation

def run():
    csv_file = open('vmb_data.csv')
    ...
    for row in reader:
        ...
        mp = MatrimonyProfile(name=row[0], gender=row[1], rounds_chanting=row[2], 
            ...
            current_city=row[10], languages_known=row[13], height=row[14], degree=d, occupation=o,
